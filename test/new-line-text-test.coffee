  ...
  context '1', ->
    it 'works', ->
      ...
      format = (nodes, options) ->
        ...
        assert nodes[0].type is 'new line text'
  ...
  context '2', ->
    it 'works', ->
      ...
      format = (nodes, options) ->
        ...
        assert nodes[1].type is 'new line text'
  ...
  context '3', ->
    it 'works', ->
      ...
      format = (nodes, options) ->
        ...
        assert nodes[0].children[0].type is 'new line text'
  ...
  context '4', ->
    it 'works', ->
      ...
      format = (nodes, options) ->
        ...
        assert nodes[0].children[1].type is 'new line text'
  ...
  context '5', ->
    it 'works', ->
      ...
      format = (nodes, options) ->
        ...
        assert nodes[0].children[2].type is 'new line text'
